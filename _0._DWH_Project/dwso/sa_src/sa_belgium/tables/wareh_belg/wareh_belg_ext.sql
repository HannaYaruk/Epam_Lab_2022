...
DROP TABLE wareh_belg_ext;

CREATE TABLE wareh_belg_ext (
...
DROP TABLE wareh_belg_b_load;

CREATE TABLE wareh_belg_b_load (
    warehouse_id           VARCHAR(256),
    warehouse_name         VARCHAR(256),
    warehouse_address      VARCHAR(256),
    warehouse_city         VARCHAR(256),
...
ORGANIZATION EXTERNAL ( TYPE oracle_loader
    ...
    ) LOCATION ( 'warehouse_bel.csv' )
);

INSERT INTO wareh_belg_ext (
    warehouse_id,
    warehouse_name,
    warehouse_address,
    warehouse_city,
...
GRANT SELECT ON wareh_belg_ext TO bl_cl;
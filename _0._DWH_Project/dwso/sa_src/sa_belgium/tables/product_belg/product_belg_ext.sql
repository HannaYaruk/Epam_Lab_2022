...
DROP TABLE prod_belg_ext;

CREATE TABLE prod_belg_ext (
...
DROP TABLE prod_belg_b_load;

CREATE TABLE prod_belg_b_load (
    product_id             VARCHAR(256),
    product_name           VARCHAR(256),
    product_desc           VARCHAR(256),
    category_name          VARCHAR(256),
...
ORGANIZATION EXTERNAL ( TYPE oracle_loader
    ...
    ) LOCATION ( 'product_bel.csv' )
);

INSERT INTO prod_belg_ext (
    product_id,
    product_name,
    product_desc,
    category_name,
...
GRANT SELECT ON prod_belg_ext TO bl_cl;
...
DROP TABLE paym_type_fra_ext;

CREATE TABLE paym_type_fra_ext (
...
ORGANIZATION EXTERNAL ( TYPE oracle_loader
    ...
    ) LOCATION ( 'payment_type_fra.csv' )
);

INSERT INTO paym_type_fra_ext (
    id_paym_type,
    paym_type,
    paym_acc
)
...
GRANT SELECT ON paym_type_fra_ext TO bl_cl;